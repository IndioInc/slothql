...
@pytest.mark.parametrize("value", (datetime.date(2005, 4, 2), datetime.time(21, 37)))
...
@pytest.mark.parametrize("value", (datetime.time(21, 37),))
...
@pytest.mark.parametrize("value", (datetime.date(2005, 4, 2),))
